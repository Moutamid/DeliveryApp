...
public class StoryActivity extends AppCompatActivity implements StoriesProgressView.StoriesListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seen_number = findViewById(R.id.seem_number);
        ...
        r_seen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("storyid", storyide.get(counter));
        ...
        story_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Story")
                        .child(userid).child(storyide.get(counter));
    ...
    public void onNext() {
        ...
        addView(storyide.get(counter));
        seenNumber(storyide.get(counter));
